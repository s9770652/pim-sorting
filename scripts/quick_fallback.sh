...
cmd="NR_TASKLETS=${NR_TASKLETS} BLOCK_SIZE=${BLOCK_SIZE} SEQREAD_CACHE_SIZE=${SEQREAD_CACHE_SIZE} PIVOT=${PIVOT} PARTITION_PRIO=${PARTITION_PRIO} RECURSIVE=${RECURSIVE} make all"
...
do
    ...
    do
        ...
        eval "QUICK_THRESHOLD=${threshold} TYPE=UINT${type} ${cmd}"
